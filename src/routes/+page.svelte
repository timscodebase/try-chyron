<script lang="ts">
	...
	import { SmoothWrapper } from '$lib/components/ui/smooth-wrapper';
	import {
...
<SmoothWrapper>
	...
	<header class="hero" style="--hero-bg: url({demoImg})">
		<div class="on-top grid">
			<div>
				<h1
					class="font-header leading-1.1 font-bold uppercase text-4xl text-center"
					{@attach createFadeInAnimation()}
					{@attach createSlideToLeftAnimation()}
				>
				...
				<p {@attach createFadeInAnimation()}>
					Add scrolling headlines, cycling news, and branded logos to your web projects in minutes.
					With TypeScript support, theme-able styles, and responsive design, chyron-svelte empowers
					developers to craft engaging, professional tickers without the hassle.
				</p>
			</div>
			<div class="full-center flex-column">
				...
				<div class="secondary-ctas">
					<a class="ctas-button" href="/demo" target="_blank">View Demo</a> |
					<a
						class="ctas-button"
	...
	<section class="features">
		...
		<ul>
			<li>
				<strong>🚀 Effortless Integration</strong>: Install via npm and start building with a single
				import. Works seamlessly with SvelteKit and TypeScript.
			</li>
			<li>
				<strong>🎨 Fully Customizable</strong>: Tailor colors, fonts, and sizes using CSS variables
				or dynamic customStyles props. Match any brand or theme.
			</li>
			<li>
			...
			<li>
				<strong>🛠 Developer-Friendly</strong>: TypeScript types, clear documentation, and a modular
				component structure make development a breeze.
			</li>
		</ul>
	...
	<section class="use-cases">
		...
		<ul>
			...
			<li>
				<strong>Sports Apps</strong>: Keep fans engaged with live score updates and sponsor logos in
				a sleek, broadcast-style chyron.
			</li>
			<li>
